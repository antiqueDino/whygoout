<?php
    $title = 'Verification des identifiants';
                    ...
                    <input type="hidden" name="pid"  value="<?php echo $pid;?>" />
                        ...
                        <div class="-mx-3 md:flex mb-4">
                            <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <div class="relative">
                                    <select class="block appearance-none w-full bg-grey-lighter border border-grey-lighter text-gray-700 py-3 px-4 pr-8 rounded" id="grid-state" name="tid" required>
                                        <?php 
                                            $reponse = $db->query("SELECT * FROM itypes ORDER BY tid ASC");
                            ...
                            <div class="md:w-1/2 px-3">
                                ...
                                <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" id="grid-city" type="text" required name = "valeur" placeholder="4KOB4569#">
                            </div> 
                        </div>   

                    <button class="text-sm py-2 px-3 bg-green-600 text-white rounded" type="submit"> Valider </button>
                </form>
