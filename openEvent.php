        ...
        <div class="w-full px-6 py-12 bg-gray-100 border-t">
            ...
            <div class="container max-w-4xl mx-auto pb-10 flex flex-wrap">
                        <?php
                            ...
                            // $format = 'd-m-Y H:i:s';
                            $SQL = "SELECT * FROM categories INNER JOIN evenements ON categories.cid = evenements.cid WHERE evenements.type ='ouvert' ORDER BY eid DESC LIMIT $offset, $perPage";
                            $event = $db->query($SQL);
                            if ($event->rowCount()==0) {
                        ?>
