...
<div class="flex py-3 px-3 mx-auto">
...
?>
        ...
        <tr>
            ...
            <td class="px-2 py-4 whitespace-normal text-right text-sm leading-5 font-medium">
              <a href="takepart.php?eid=<?php echo $donnees['eid'] ;?>" class="text-indigo-600 hover:text-indigo-900 focus:outline-none focus:underline">Présents</a>
            </td>
